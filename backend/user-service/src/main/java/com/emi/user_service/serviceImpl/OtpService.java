...
public class OtpService {
   ...
   private final Map<Long, Long> lastRequestTime = new HashMap<>();
    ...
    public void sendOtp(Long phoneNumber){
      ...
      public boolean verifyOtp(UUID userKeycloakId, Long phoneNumber, String otp) {
      ...
      kycService.updateStatus(userKeycloakId);
      return true;
    }
}
